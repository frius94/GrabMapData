...
public class Poi {
    ...
    public Poi(Summary summary, ArrayList<Results> results) {
    ...
    public void printInformation() {
        ...
        if (this.getResults().size() == 0) {
            ...
            for (poi.Results r : this.getResults()) {
                if (r.getPoi().getName() != null)
                    System.out.println("Name: " + r.getPoi().getName());
                if (r.getPoi().getCategories().size() != 0) {
                    System.out.println("Kategorien: ");
                    for (String s :
                            r.getPoi().getCategories()) {
